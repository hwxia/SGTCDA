...
class SGTCDA(nn.Module):
    def __init__(self, n_in_features: int, hid_features: int, heads: int,
        ...
        self.reconstructions = InnerProductDecoder(
            name='gan_decoder',
            input_dim=hid_features, num_d=self.n_drug, act=torch.sigmoid)  # input_dim=128 num_d=218
    ...
    def forward(self, x, edge_idx, x_drug, edge_idx_drug, x_cir, edge_idx_cir):
        ...
        cnn_embd_hetro = hetro_gcn1.t().view(1, 2, self.hid_features, self.n_drug + self.n_cir)

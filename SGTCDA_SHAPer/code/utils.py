...
def construct_train_dataset(train_pos_edges, train_neg_edges):
    num_columns = train_pos_edges.shape[1]
    tmp_train_pos_edges = []
    tmp_train_neg_edges = []
...
def symmetric_to_upper_triangular(matrix):
    upper_triangular_indices = np.triu_indices(matrix.shape[0])
    upper_triangular_matrix = np.zeros_like(matrix)
    upper_triangular_matrix[upper_triangular_indices] = matrix[upper_triangular_indices]
